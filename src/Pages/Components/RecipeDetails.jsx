        ...
        Object.keys(details).length ? (
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} sx={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
              ...
              <Typography variant="body" color="base0" sx={{ mt: '16px' }}>{details.description}</Typography>
              ...
              <Box sx={{ mt: '20px', display: 'flex', flexWrap: 'wrap', gap: '32px' }}>
                ...
                <Infbox>
                  <Box ><img src={CaloriesIcon}></img></Box>
                  <Typography variant="body">{details.caloricity} kCal</Typography>
                </Infbox>

                <Infbox>
                  <Box ><img src={cuisineIcon}></img></Box>
              ...
              <ul style={{ paddingLeft: '20px' }}>
                {details.ingredients.map((ingredient, index) => {
                  return (<li key={index} ><Typography variant="body" color='base0'>{ingredient} </Typography></li>)
                })}
              </ul>
